...
This file contains my problem formulation for the problem BFS
'''
...
print("\nWelcome to BFS")
COUNT = None #don't think i need this. i think count is for Itr
BACKLINKS = {}
...
# STEP 5. Delete from L nay members of OPEN that occur on L.
